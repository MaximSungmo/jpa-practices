...
@EnableJpaRepositories(basePackages = { "me.kickscar.practices.jpa03.model04.repository" })
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        // 엔티티(@Entity) 탐색 시작 위치
        em.setPackagesToScan(new String[] { "me.kickscar.practices.jpa03.model04.domain" });
        // 하이버네이트 구현체 사용
